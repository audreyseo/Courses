...
sub saveBad{
  ...
  my ($name) = shift(@_);
  my ($fileName) = "/users/Audrey/Personal/Programming/Python/Workspace/WellesleyCourses/Parsed/Old/Bad/$name.html";
...
.
    my $log = "/users/Audrey/Personal/Programming/Python/Workspace/WellesleyCourses/Parsed/log.txt";
